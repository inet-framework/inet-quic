 ...
 *
 * 3. The arrival clock time of a clock event is always greater than or equal
 *    to the current clock time.
 *
 * 4. The arrival simulation time of a clock event is equal to the expected
 *    simulation time when the clock will be at the arrival clock time of the
 *    clock event.
 *
 * 5. The arrival clock time of a clock event is equal to the expected clock
 *    time of the clock at the arrival simulation time of the clock event.
 */
